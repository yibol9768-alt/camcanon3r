...
registered threshold.  Thus the failure is tied to off-center camera changes
and amplified by view dependence, not generic resampling; cross-dataset
generality, failure detection, and repair remain separate empirical claims.
\end{abstract}
